...
export default function LearnPage() {
  return (
    <div className="page max-w-5xl">
      <h1 className="display display-page">Learn</h1>
      <p className="mt-4 max-w-2xl text-base text-ink/70 sm:text-lg">Guided paths, a short glossary, and links to go further.</p>
      <div className="mt-8 grid gap-6 sm:mt-12 md:grid-cols-3">
        {Object.values(paths).map((p) => (
          <Link key={p.slug} href={`/learn/${p.slug}`} className="border border-ink/10 p-6 hover:shadow-card">
            ...
            <h2 className="display display-section mt-2">{p.title}</h2>
      ...
      <section className="mt-20">
        <h2 className="display display-section">Glossary</h2>
      ...
      <section className="mt-20">
        <h2 className="display display-section">More to read</h2>
        {outbound.map((g) => (
