...
export default function ReadymadePage() {
  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-16 md:px-6">
      <p className="chip">Selection is the act</p>
      <h1 className="display mt-4 text-5xl">Readymade</h1>
      <p className="mt-4 text-ink/70">Pick an everyday object. The title does the rest. Then ask: where is the art?</p>
